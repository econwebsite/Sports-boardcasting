...
const BigImageWithCategories: React.FC = () => {
  ...
  const categories: (CategoryProps & { imageAlign: 'left' | 'right' })[] = [
    {
      id: 'point-3',
      title: 'Swing Analysis Cameras',
      description: 'Capture every detail of your swing, review it in slow motion, and gain the insights you need to perfect your technique and boost your performance. Our cameras provide the precision and clarity needed to track and analyze your swing history over time...',
      features: [
      ...
      datasheetLink: 'https://www.e-consystems.com/doc-2mp-global-shutter-color-camera.asp',
      buyNowLink: 'https://www.e-consystems.com/order-now/see3cam_24cug.asp#see3cam24cug',
      contactLink: '#',
      imageAlign: 'right',
    },
    {
      ...
      productLinks: [
        'https://www.e-consystems.com/nvidia-cameras/jetson-orin-nx-cameras/5mp-imx568-global-shutter-camera.asp',
        'https://www.e-consystems.com/sony-imx264-camera.asp',
        'https://www.e-consystems.com/sony-imx264-camera.asp',
      ],
      contactLink: '#',
    ...
    },
    {
      ...
      description: 'Launch monitors are portable, compact, and battery-powered devices typically used to capture golf trajectory information, especially in outdoor play areas. They utilize radar, cameras, or a combination of both to measure key metrics such as ball speed, launch angle, and distance. This data provides valuable feedback to help improve your game.',
      features: [
        'High Resolution Autofocus and Fixed Focus Cameras',
        'USB & MIPI Interface',
        'Supports embedded platforms such as NVIDIA, NXP, Qualcomm and more',
        '<b>13MP Auto focus Camera</b> <a href="https://www.e-consystems.com/13mp-autofocus-usb-camera.asp" target="_blank" style="font-weight: normal;">click here »</a>',
        '<b>20MP Fixed focus Camera</b> <a href="https://www.e-consystems.com/usb-cameras/ar2020-20mp-high-resolution-camera.asp" target="_blank" style="font-weight: normal;">click here »</a>',
      ],
      ...
      productLinks: [
        ...
        'https://www.e-consystems.com/toradex/13mp-camera-for-imx8-quad-max.asp',
        'https://www.e-consystems.com/usb-cameras/ar2020-20mp-high-resolution-camera.asp',
      ],
      imageAlign: 'right',
    },
  ];
  ...
  return (
    <div className="col-lg-12 d-lg-flex flex-column align-items-center text-justify mb-3">
      ...
      <div ref={point3Ref} className="w-100">
        <CategorySection {...categories[0]} />
      </div>
      <div ref={point2Ref} className="w-100">
        <CategorySection {...categories[1]} />
      </div>
      <div ref={point1Ref} className="w-100">
